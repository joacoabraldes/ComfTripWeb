...
const en = {
  ...
  community: {
    ...
    send: 'Send',
      sending: 'Sending…',
    hint: 'Send by email or by username',
      searchUser: "Search user...",
    incomingRequests: 'Incoming requests',
    noIncoming: 'No incoming requests',
      noSearchIncoming: 'There are no incoming requests for this name or email',
    friends: 'Friends',
    noFriends: 'You don\'t have any friends yet',
      noSearchFriends: 'You have no friends with this name or email',
    outgoingRequests: 'Sent requests (pending)',
    noOutgoing: 'No pending sent requests',
      noSearchOutgoing: 'There are no pending requests sent to this name or email',
    status: 'Status:',
    ...
    cannotDetermineUser: 'Could not determine your user. Try reloading the page or logging in again.',
      titleFeed: 'Social feed',
      publish: 'Publish',
      publishing: 'Publishing…',
      addPhoto: 'Add photo',
      changePhoto: 'Change photo',
      noPost: 'There are no posts yet. Start by creating your first post.',
      hintPost: 'Your friends will see your posts in chronological order.',
      inputPost:'What do you want to share with your friends about your trips?',
      loadingFeed:'Loading feed…',
      errorFeed:'Error loading the feed',
      errorCreatePost: 'Error creating the post',
      errorLike: 'Error changing like',
      errorLoadingCom: 'Error loading comments',
  ...
  explore: {
    ...
    errorCreatePlace: 'Could not create place.',
    errorLoadLocations: 'Could not load locations.',
    errorDeterminePlaceId: 'Could not determine place id.',
    title: 'Explore by categories',
    ownerBubbleText: 'Are you the owner or administrator of a tourist place? Publish it on ComfTrip so more travelers can find it.',
    addPlace: 'Add place',
    placesForTrip: 'Places for your trip to {tripTitle}',
    loadingTripPlaces: 'Loading trip places…',
    errorLoadTripPlaces: 'Could not load trip places: {error}',
    noNewRecommendations: 'No new recommendations for this trip (or you already added the most relevant ones).',
    country: 'Country',
    city: 'City',
    sortBy: 'Sort by',
    ...
    cityLabel: 'City:',
    sortLabel: 'Sort:',
    recommendedPlacesWorld: 'Recommended places in the world',
    placesOfCategory: 'Places of {category}',
    addPlaceModal: {
      title: 'Add a place',
      subtitle: 'Complete the basic data. You can paste multiple images separated by comma.',
      name: 'Name',
      nameRequired: 'Complete the place name and a category.',
      category: 'Category',
      description: 'Description',
      latitude: 'Latitude',
      longitude: 'Longitude',
      openingHours: 'Opening hours (free format)',
      website: 'Website',
      images: 'Images (URLs separated by comma)',
      namePlaceholder: 'E.g: Teatro Colón',
      countryPlaceholder: 'Argentina',
      cityPlaceholder: 'Buenos Aires',
      latitudePlaceholder: '-34.6010807',
      longitudePlaceholder: '-58.3831792',
      openingHoursPlaceholder: 'E.g: "Mo-Sa 09:00-20:00; Su 09:00-17:00"',
      websitePlaceholder: 'https://...',
      imagesPlaceholder: 'https://... , https://...',
      descriptionPlaceholder: 'Tell us what makes this place special…',
    },
    detailModal: {
      ...
      errorLoadReviews: 'Could not load reviews: {error}',
  ...
  socialFeed: {
    ...
    beFirstToComment: 'No comments yet. Be the first to comment.',
    ...
    imageUrlsPlaceholder: 'Image URLs separated by comma (optional)',
    tripThoughtsPlaceholder: 'What are you thinking about for your trip?',
    errorLoadingFeed: 'Error loading feed',
    errorCreatePost: 'Error creating post',
    errorToggleLike: 'Error toggling like',
    errorLoadingComments: 'Error loading comments',
    errorAddingComment: 'Error adding comment',
    errorPublishComment: 'Could not publish comment',
  },
