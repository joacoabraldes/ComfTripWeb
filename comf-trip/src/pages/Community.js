...
import {
    ...
    fetchPostComments,
    addPostComment,
    deleteSocialPost, deletePostComment,
    ...
    return (
        <div>
            ...
            <ConfirmDialog
                ...
                title={isRemoveFriend ? t('community.removeTitle') :( isRemovePost ? t('community.removePostTitle') : (isRemoveComment ? t('community.removeCommentTitle') : "")) }
                message={isRemoveFriend ? t('community.removeConfirm') :( isRemovePost ? t('community.removePostConfirm') : (isRemoveComment ? t('community.removeCommentConfirm') : "")) }
